...
/**
 * The type Employee mongo db facade.
 */
@Service
...
public class EmployeeMongoDbFacade implements EmployeeRepository {
    ...
    /**
     * Instantiates a new Employee mongo db facade.
     *
     * @param employeeMongoDbRepository the employee mongo db repository
     * @param employeeMongoDbMapper     the employee mongo db mapper
